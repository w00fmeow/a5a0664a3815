    ...
    def process_file(self, file_path):
        with open(file_path, mode='r') as file:
            ...
            for row in csv_reader:
                self.extract_credentials_from_row(row, password_column_index, email_column_index, file_path)

    def extract_credentials_from_row(self, row, password_column_index, email_column_index, file_path):
        try:
